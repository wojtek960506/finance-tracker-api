...
export const ACCOUNT_EXPENSE_ID_STR = randomObjectIdString();
export const ACCOUNT_EXPENSE_ID_OBJ = new Types.ObjectId(ACCOUNT_EXPENSE_ID_STR);
export const ACCOUNT_INCOME_ID_STR = randomObjectIdString();
export const ACCOUNT_INCOME_ID_OBJ = new Types.ObjectId(ACCOUNT_INCOME_ID_STR);
export const PAYMENT_METHOD_NAME = 'bankTransfer';
...
export const EXCHANGE_TXN_EXPENSE_ID_OBJ = new Types.ObjectId(
...
export const TRANSFER_TXN_EXPENSE_ID_OBJ = new Types.ObjectId(
